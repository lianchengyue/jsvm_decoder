#ifndef _SEQUENCEPARAMETERSET_H_
#define _SEQUENCEPARAMETERSET_H_
...
public:
    ...
    Void  setOffsetForRefFrame (UInt ui, Int i)          { m_piOffsetForRefFrame[ui]          = i;  }
    ...
    ErrVal initOffsetForRefFrame(UInt uiSize)
    {
        ...
        m_piOffsetForRefFrame.uninit();
        m_piOffsetForRefFrame.init(uiSize);
...
#endif //_SEQUENCEPARAMETERSET_H_
