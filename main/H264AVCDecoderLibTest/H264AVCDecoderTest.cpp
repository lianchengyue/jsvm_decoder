...
ErrVal H264AVCDecoderTest::BufferParameters::init( const h264::AccessUnit& rcAccessUnit )
{
                                 ...
                                 #endif
{
    ...
    h264::CreaterH264AVCDecoder::create(pcH264AVCDecoder);
...
ErrVal H264AVCDecoderTest::xProcessAccessUnit( h264::AccessUnit& rcAccessUnit, Bool& rbFirstAccessUnit, UInt& ruiNumProcessed )
{
